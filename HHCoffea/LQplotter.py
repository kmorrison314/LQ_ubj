...
#    TT = event_yields[]
#    print("DY event yields", event_yields["DY"]
#    print("TT event yields", event_yields["TT"]
...
def main():
    ...
    #print('the normalizations are', normalizations)
    ...
    #print('df is', df)
    df.to_csv(os.path.join(outdir, "df_dict.csv"), sep="\t")
